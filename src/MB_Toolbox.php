<?php
/*
 * Message Broker ("MB") toolbox class library. A collection of common methods used throughout the Message
 * Broker system.
 */
...
class MB_Toolbox
{
    ...
    public function createDrupalUser($user)
    {
        ...
        if (filter_var($user->email, FILTER_VALIDATE_EMAIL)) {
            ...
            $post = [
                ...
                'user_registration_source' => isset($user->user_registration_source) ?
                    $user->user_registration_source : '',
            ];
     ...
     *
     * @param object $user Values used to define the user created in Northstar.
     *
     * @return object The values returned from Northstar as a result of user creation.
     */
